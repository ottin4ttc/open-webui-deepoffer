...
# 添加短信配置初始化
app.state.config.ENABLE_SMS = ENABLE_SMS
app.state.config.ALIYUN_SMS_ACCESS_KEY_ID = ALIYUN_SMS_ACCESS_KEY_ID
app.state.config.ALIYUN_SMS_ACCESS_KEY_SECRET = ALIYUN_SMS_ACCESS_KEY_SECRET
app.state.config.ALIYUN_SMS_SIGN_NAME = ALIYUN_SMS_SIGN_NAME
app.state.config.ALIYUN_SMS_TEMPLATE_CODE = ALIYUN_SMS_TEMPLATE_CODE
app.state.config.ALIYUN_SMS_REGION_ID = ALIYUN_SMS_REGION_ID
app.state.config.SMS_VERIFICATION_CODE_LENGTH = SMS_VERIFICATION_CODE_LENGTH
app.state.config.SMS_VERIFICATION_CODE_EXPIRE_SECONDS = SMS_VERIFICATION_CODE_EXPIRE_SECONDS
app.state.config.SMS_VERIFICATION_CODE_DAILY_LIMIT = SMS_VERIFICATION_CODE_DAILY_LIMIT
app.state.config.SMS_VERIFICATION_CODE_INTERVAL_SECONDS = SMS_VERIFICATION_CODE_INTERVAL_SECONDS
